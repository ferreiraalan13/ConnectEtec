      ...
      <div className="w-4/5 h-4/5 flex bg-gray-100 rounded-md shadow-lg z-10 overflow-auto md:max-w-4xl md:h-auto">
        ...
        <div className="w-full md:w-3/5 lg:w-2/3 p-8 md:p-16 flex flex-col gap-8">
          ...
          <form action="" className="flex flex-col gap-6">
            ...
            <button type="submit" className="mt-4 transition bg-gray-300 hover:bg-gray-500 hover:text-gray-100 font-bold py-1 px-2 rounded-2xl drop-shadow-md" onClick={()=> navigate("/")}>
              Cadastre-se
            </button>
          </form>
        </div>
